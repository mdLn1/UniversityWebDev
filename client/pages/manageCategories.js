...
export default  class manageCategories extends Component {
    ...
    createCategory = async () => {
        try {
            ...
            const obj = { tag: this.state.categoryTitle, description: this.state.categoryDescription, isSelectable: this.state.availability };
    ...
    render() {
        return (
            <Layout>
                ...
                verticalAlign="top"
                >
                <Grid.Column style={{ maxWidth: 450, paddingTop: '8%'}}>
                    ...
                    <Segment stacked>
                        ...
                        />
                        <label style = {{paddingBottom:'4%', fontSize:15}} value = "availability">
                            Would you like to make this category available ? 
                        </label>
                        <div>
                            <Checkbox 
                            style = {{paddingTop:'4%'}}
                            onChange={this.handleAvailabilityChange} toggle 
                            />
                        </div>
