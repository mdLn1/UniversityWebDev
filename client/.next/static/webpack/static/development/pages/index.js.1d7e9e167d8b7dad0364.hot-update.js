...
var ElectionIndex = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(ElectionIndex, [{
    key: "render",
    // renderIdeas() {
    //   const items = this.props.ideas.map((idea, index) => {
    //     return {
    //       key: index,
    //       header: idea.Title,
    ...
    value: function render() {
      return __jsx(_components_Layout__WEBPACK_IMPORTED_MODULE_10__["default"], null, __jsx("div", null, __jsx("h3", null, "Dashboard Homepage"), __jsx("br", null), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_11__["Pagination"], {
        boundaryRange: 0,
        defaultActivePage: 1,
        ellipsisItem: null,
        firstItem: null,
    ...
    value: function getInitialProps(props) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              numberOfPages = Math.ceil(res.data["totalIdeas"] / 5); //return { ideas, numberOfPages };

              console.log(ideas, numberOfPages);
              _context.next = 12;
              break;
      ...
      }, null, this, [[0, 9]], _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a);
    }
  }]);
...
//# sourceMappingURL=index.js.1d7e9e167d8b7dad0364.hot-update.js.map