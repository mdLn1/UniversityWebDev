...
var LoginForm = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(LoginForm, [{
    ...
    value: function render() {
      var dptOptions = this.state.departments.map(function (dpt, index) {
        return {
          key: dpt.department,
          text: dpt.department,
      ...
      var rolesOptions = this.state.roles.map(function (role, index) {
        return {
          key: role.roles,
          text: role.roles,
          value: role.roles
...
//# sourceMappingURL=signup.js.687c51bb0e4ab7c240e0.hot-update.js.map