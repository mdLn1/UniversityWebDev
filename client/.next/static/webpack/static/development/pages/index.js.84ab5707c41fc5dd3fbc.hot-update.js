  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(ElectionIndex, [{
    ...
    value: function renderIdeas() {
      var items = this.state.listOfIdeas.map(function (idea, index) {
        ...
        var extra = __jsx("div", {
          style: style
        }, __jsx("div", null, __jsx("p", null, "Posted by: ", __jsx("strong", null, idea.author)), __jsx("p", null, "Date: ", __jsx("strong", null, idea.posted_time.slice(0, 10)))));
...
//# sourceMappingURL=index.js.84ab5707c41fc5dd3fbc.hot-update.js.map